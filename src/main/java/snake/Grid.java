...
public class Grid {
    ...
    public boolean testWall() {
        ...
        if (Game.getSnake().findMoveCoordinate().getRow() == 0 || Game.getSnake().findMoveCoordinate().getRow() == 1 || 
            Game.getSnake().findMoveCoordinate().getRow() == getGridWidth() - 2 || Game.getSnake().findMoveCoordinate().getRow() == getGridWidth() -  1)
            return true;
        // RED_FLAG: where did these numbers come from?!
        if (Game.getSnake().findMoveCoordinate().getCol() == 0 || Game.getSnake().findMoveCoordinate().getCol() == 1 ||
            Game.getSnake().findMoveCoordinate().getCol() == getGridHeight() - 2 || Game.getSnake().findMoveCoordinate().getCol() == getGridHeight() -1)
            return true;
        return false;
    }
